...
*The analysis below was generated by Codex (GPT-6) in collaboration with [lintool](https://github.com/lintool).*

The original text above is retained as a historical record.
...
| :----------------- | ----------: | ---------: | -------------: | ------------: | ---------: | ------: | --------------: |
| Recall@1000        |        0.82 |       0.68 |           0.82 |          0.68 |     0.1874 |  0.1957 |          0.8573 |
| MRR@10             |        0.60 |       0.62 |           0.60 |      **0.58** |     0.1895 |  0.1976 |          0.8544 |
| MAP                |        0.60 |       0.62 |           0.60 |          0.62 |     0.1892 |  0.1972 |          0.8555 |

+ Recall and MAP recover the original parameter averages and development scores.
+ MRR selects `b=0.58` instead of `b=0.62`, giving MRR@10 0.1895 instead of the historical 0.1892; MRR and MAP no longer select the same average.
+ Separately, re-evaluating all three historical fixed-parameter pairs reproduces their published scores at four decimal places when emitted ranks are preserved during conversion.

*End of analysis generated by Codex (GPT-6) in collaboration with [lintool](https://github.com/lintool).*
...
+ Results reproduced by [@stephaniewhoo](https://github.com/stephaniewhoo) on 2020-04-26 (commit [`8f48f8e`](https://github.com/castorini/anserini/commit/8f48f8e40a37e5f6b5910a3a3b5c050a0f9be914))
+ Results reproduced by [@eiston](https://github.com/eiston) on 2020-05-04 (commit [`dd84a5a`](https://github.com/castorini/anserini/commit/dd84a5a514700365d9aa4a1ea988107372515f33))
+ Results reproduced by [@rohilg](https://github.com/rohilg) on 2020-05-09 (commit [`20ee950`](https://github.com/castorini/anserini/commit/20ee950fbdc5cc9ce1c993911cbca4fcbfa86d02))
...
+ Results reproduced by [@stariqmi](https://github.com/stariqmi) on 2020-05-28 (commit [`455169e`](https://github.com/castorini/anserini/commit/455169ea6a09f637817a6c4b4f6837dcc845f5f7))
...
+ Results reproduced by [@ljatca](https://github.com/ljatca) on 2022-12-08 (commit [`6872c87`](https://github.com/castorini/anserini/commit/6872c878d6969ebdf1875e4436777b95746b35a5))
...
+ Results reproduced by [@Cathrineee](https://github.com/Cathrineee) on 2023-01-14 (commit [`732cba4`](https://github.com/castorini/anserini/commit/732cba4775312f606888778d1e705e1ccea926df))
...
+ Results reproduced by [@NMA19](https://github.com/NMA19) on 2026-07-12 (commit [`2a68adb`](https://github.com/castorini/anserini/commit/2a68adb9bb9ec8b180c0828d882e108a00bff7b5))
